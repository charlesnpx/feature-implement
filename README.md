...
perl -0pi -e 's/^name:\s*"?feature"?\s*$/name: "feature-exp"/m; s/\$feature/\$feature-exp/g; s/`feature /`feature-implement-exp /g; s/^feature /feature-implement-exp /mg' "$HOME/.codex/skills/feature-exp/SKILL.md"
perl -0pi -e 's/^name:\s*"?feature:implement"?\s*$/name: "feature-exp:implement"/m; s/\$feature:implement/\$feature-exp:implement/g; s/\$feature/\$feature-exp/g; s/`feature /`feature-implement-exp /g; s/^feature /feature-implement-exp /mg' "$HOME/.codex/skills/feature-exp:implement/SKILL.md"
