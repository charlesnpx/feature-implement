...
7. Run a PR review loop with a maximum of 10 fresh-review iterations. For each review with worthwhile findings, apply the selected fixes locally, run checks, close that reviewer subagent, then commit and push the accepted fixes.
