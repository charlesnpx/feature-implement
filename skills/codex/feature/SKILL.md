...
9. Run at most three plan-review iterations. Each iteration asks a fresh Codex subagent to review the source bundle for missing implementation detail, invalid dependencies, unsafe grouping, policy weakening, unusable path constraints, missing authority inputs, and direct CLI incompatibility. Do not use a PR-review skill for this plan review.
