...
9. Ask a fresh Claude subagent to review the source bundle for missing implementation detail, invalid dependencies, unsafe grouping, policy weakening, unusable path constraints, missing authority inputs, and direct CLI incompatibility.
