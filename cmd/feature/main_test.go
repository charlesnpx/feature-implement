...
func TestWorkspaceAttemptStartCommandJSON(t *testing.T) {
	...
	wantCommand := "git -C " + workspaceDir + " worktree add -b feature/workspace-a/foundation/story-a/attempt-1 " + attempt.Worktree + " base-sha-cli"
