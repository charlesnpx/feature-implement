...
var SupportedActions = []string{"init", "validate", "status", "next", "heartbeat", "release", "recover", "refresh-branch", "publish-refresh", "evaluate-gates", "attempt", "transition", "contract", "approve", "external"}
