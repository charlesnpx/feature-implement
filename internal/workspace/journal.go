...
func validateResourceKey(value string) error {
	...
	switch parts[0] {
	case "workspace", "merge_unit", "lease", "base_ref", "contract", "contract_binding", "approval", "external_intent", "provider_target", "remote_ref", "merge_queue", "queue_slot", "refresh", "gate":
		return nil
	default:
